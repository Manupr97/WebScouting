...
# Función para obtener estadísticas del dataset - COMPLETAMENTE SILENCIOSA
@st.cache_data
def get_wyscout_stats():
    ...
    try:
        ...
        # Calcular estadísticas silenciosamente
        stats = {
...
def cargar_lista_visualizacion():
    ...
    try:
        filepath = os.path.join(parent_dir, 'data', 'lista_visualizacion.json')
...
partido_model = PartidoModel()  # AÑADIDO: Inicializar partido_model
...
if not login_manager.is_authenticated():
    ...
    # Usuario autenticado
    current_user = login_manager.get_current_user()  # CORREGIDO: Cambio de user_data a current_user
    
    # Cargar datos de Wyscout COMPLETAMENTE EN SILENCIO
    ...
    # === TOP PERFORMERS REALES CON FILTRO DE MINUTOS ===
    ...
    # APLICAR FILTRO DE MINUTOS MÍNIMOS PARA JUGADORES RELEVANTES
    min_minutes = 1700
    ...
    with col_perf2:
        ...
        # Top en interceptaciones con minutos
        ...
        # Entrada/duelos defensivos con minutos
        ...
        if 'pos_principal' in df_filtered_minutes.columns:
            try:
                ...
                if not porteros_df.empty:
                    ...
                    # Número total de porteros con minutos relevantes
                    st.markdown(f"""
    ...
    # === NUEVA SECCIÓN: ¿QUÉ PUEDO HACER? - VERSIÓN DINÁMICA ===
    st.markdown("""
    ...
    # Determinar el estado del usuario basado en datos reales
    ...
    # Crear recomendaciones personalizadas basadas en el estado
    if estado_usuario['es_nuevo']:
        ...
        # Usuario con jugadores pendientes de evaluar
        st.markdown(f"""
    ...
    # Sección de accesos rápidos siempre visible
    st.markdown("---")
